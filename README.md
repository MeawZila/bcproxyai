...
- 🌐 **14 Providers** — NVIDIA NIM, OpenRouter, Groq, Cerebras, Mistral, Ollama และอื่นๆ
...
└──────────────┘                                           │
                 ...
                 └──┬──────────┬──────────┬──────────┬──────────┬─────────────┘
                    ▼          ▼          ▼          ▼          ▼
                 ┌──────┐  ┌─────┐  ┌─────────┐  ┌────────┐  ┌────────┐
                 │NVIDIA│  │Groq │  │Cerebras │  │Mistral │  │10 more │
                 └──────┘  └─────┘  └─────────┘  └────────┘  └────────┘
...
**Providers ที่รองรับ (ฟรีหมด 14 เจ้า):**

| Provider | ENV var | Model count¹ | ลิงก์สมัคร |
|---|---|---|---|
| NVIDIA NIM | `NVIDIA_API_KEY` | ~168 | https://build.nvidia.com/ |
| Mistral | `MISTRAL_API_KEY` | ~60 | https://console.mistral.ai |
| OpenRouter | `OPENROUTER_API_KEY` | ~28 | https://openrouter.ai/keys |
| Groq | `GROQ_API_KEY` | ~18 | https://console.groq.com/keys |
| SambaNova | `SAMBANOVA_API_KEY` | ~13 | https://cloud.sambanova.ai |
| Cerebras | `CEREBRAS_API_KEY` | ~4 | https://cloud.cerebras.ai |
| Google AI | `GOOGLE_AI_API_KEY` | varies | https://aistudio.google.com/apikey |
| Ollama (local) | — | all local | https://ollama.com |
| DeepSeek (judge) | `DEEPSEEK_API_KEY` | judge only | https://platform.deepseek.com |
| Kilo, GitHub, Fireworks, Cohere, Cloudflare, HuggingFace | see `.env.example` | optional | |

¹ นับเฉพาะ chat model หลังกรอง embedding/rerank/audio/safety ออก — รวม ~300 models

### NVIDIA NIM โควต้าฟรี
- **~1000 requests/เดือน** per API key (NVIDIA Developer account)
- เข้าถึงได้ทุก model ในรายการ เช่น `meta/llama-3.3-70b-instruct`, `deepseek-ai/deepseek-r1-distill-llama-8b`, `nvidia/llama-3.1-nemotron-70b-instruct`
- รองรับ vision: `meta/llama-3.2-11b-vision-instruct`, `nvidia/neva-22b`
